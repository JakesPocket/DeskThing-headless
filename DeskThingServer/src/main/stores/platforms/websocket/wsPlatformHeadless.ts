...
import { getUserDataPath } from '@server/utils/pathsHeadless'

/**
 * Headless WebSocket Platform - no Electron dependencies
 */
export class WebSocketPlatformHeadless extends EventEmitter<PlatformEvents> implements PlatformInterface {
